...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
        ...
        tabTextColor = a.getColor(1,R.color.button_material_light);
        ...
        dividerMargin = a.getDimensionPixelSize(R.styleable.PagerSlidingTabStrip_pstsDividerMarginLeftRight, dividerMargin);
...
//        defaultTabLayoutParams.leftMargin = dividerMargin;
//        defaultTabLayoutParams.rightMargin = dividerMargin;
...
//        if (position == 0)
//            tab.getTabItemTxt().setSelected(true);
//        addTab(position, tab);
//    }
...
//                tab.getTabItemTxt().setPadding(tabPadding, tabPaddingTopBottom, tabPadding, tabPaddingTopBottom);
//                // setAllCaps() is only available from API 14, so the upper case is made manually if we are on a
//                // pre-ICS-build
//                if (textAllCaps) {
//                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.ICE_CREAM_SANDWICH) {
...
//                    } else {
//                        tab.getTabItemTxt().setText(tab.getTabItemTxt().getText().toString().toUpperCase(locale));
//                    }
//                }
//            }
        }
...
//                            tab.getTabItemTxt().setSelected(true);
//                        else
//                            tab.getTabItemTxt().setSelected(false);
//                    }
                }
