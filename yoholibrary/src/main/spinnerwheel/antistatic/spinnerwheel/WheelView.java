...
public class WheelView extends View {
	...
	// private static final int[] SHADOWS_COLORS = new int[] { R.color.white,
	...
	private void initResourcesIfNecessary() {
		...
		//
		if (topShadow == null) {
			topShadow = getResources().getDrawable(R.drawable.top_shadow);
		}

		if (bottomShadow == null) {
			bottomShadow = getResources().getDrawable(R.drawable.bottom_shadow);
		}
	}
	...
	private void drawShadows(Canvas canvas) {
		int height = (int) (0.5 * getItemHeight());
