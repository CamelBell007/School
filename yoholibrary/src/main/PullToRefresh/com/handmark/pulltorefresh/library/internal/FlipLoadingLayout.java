...
public class FlipLoadingLayout extends LoadingLayout {
	...
	public FlipLoadingLayout(Context context, final Mode mode, final Orientation scrollDirection, final PullToRefreshBase.AnimationStyle style,TypedArray attrs) {
