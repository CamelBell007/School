...
import com.handmark.pulltorefresh.library.internal.Custom1LoadingLayout;
import com.handmark.pulltorefresh.library.internal.Custom2LoadingLayout;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
    ...
    public final void setAutoLoading(boolean loading) {
        mIsAutoLoading = loading;
    }
    ...
    public final void setScrollLoadEnabled(boolean enabled) {
        if (enabled) {
    ...
    public static enum AnimationStyle {
        ...
        LoadingLayout createLoadingLayout(Context context, Mode mode, Orientation scrollDirection, TypedArray attrs) {
            switch (this) {
                case ROTATE:
                default:
                    return new RotateLoadingLayout(context, mode, scrollDirection, this, attrs);
                case FLIP:
                    return new FlipLoadingLayout(context, mode, scrollDirection, this, attrs);
                case CUSTOM1:
                    return new Custom1LoadingLayout(context, mode, scrollDirection, this, attrs);
                case CUSTOM2:
                    return new Custom2LoadingLayout(context, mode, scrollDirection, this, attrs);
            }
        }
    }
